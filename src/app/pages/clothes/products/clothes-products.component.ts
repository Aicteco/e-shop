...
@Component({
  ...
  styleUrls: ['./clothes-products.component.scss']
})
export class ClothesProductsComponent implements OnInit {
  ...
  getSlide(id){String(id)
    this.spinner.show();
   this.productServices.getAll('1','900', String(id),'2','').subscribe(res =>{
