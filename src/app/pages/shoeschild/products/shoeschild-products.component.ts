...
@Component({
  selector: 'app-shoeschild-products',
  templateUrl: './shoeschild-products.component.html',
  styleUrls: ['./shoeschild-products.component.scss']
})
export class ShoeschildProductsComponent implements OnInit {
  ...
  getSlide(id){
    this.spinner.show();
   this.productServices.getAll('1','900', String(id),'7','').subscribe(res =>{
