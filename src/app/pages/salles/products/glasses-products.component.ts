...
@Component({
  selector: 'app-glasses-products',
  templateUrl: './glasses-products.component.html',
  styleUrls: ['./glasses-products.component.scss']
})
export class GlassesProductsComponent implements OnInit {
...
term:string;
 ...
 private spinner:NgxSpinnerService,
  ...
  getSlide(id){String(id)
    this.spinner.show();
   this.productServices.getAll('1','900', String(id),'16','').subscribe(res =>{
