...
@Component({
  selector: 'app-devices-products',
  templateUrl: './devices-products.component.html',
  styleUrls: ['./devices-products.component.scss']
})
export class DevicesProductsComponent implements OnInit {
...
description : string;
 ...
 private spinner:NgxSpinnerService,
  ...
  getSlide(id){
    this.spinner.show();
   this.productServices.getAll('1','900', String(id),'14','').subscribe(res =>{
