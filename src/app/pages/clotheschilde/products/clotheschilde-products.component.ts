...
@Component({
  selector: 'app-clotheschilde-products',
  templateUrl: './clotheschilde-products.component.html',
  styleUrls: ['./clotheschilde-products.component.scss']
})
export class ClotheschildProductsComponent implements OnInit {
 ...
 private spinner:NgxSpinnerService,
  ...
  getSlide(id){String(id)
    this.spinner.show();
   this.productServices.getAll('1','900', String(id),'4','').subscribe(res =>{
