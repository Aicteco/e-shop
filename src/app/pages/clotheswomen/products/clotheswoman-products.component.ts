...
@Component({
  selector: 'app-clotheswoman-products',
  templateUrl: './clotheswoman-products.component.html',
  styleUrls: ['./clotheswoman-products.component.scss']
})
export class ClotheswomanProductsComponent implements OnInit {
  ...
  getSlide(id){
    this.spinner.show();
   this.productServices.getAll('1','900', String(id),'3','').subscribe(res =>{
