...
@Component({
  ...
  styleUrls: ['./furniture-products.component.scss']
})
export class FurnitureProductsComponent implements OnInit {
...
description : string;
  ...
  getSlide(id){String(id)
    this.spinner.show();
   this.productServices.getAll('1','900', String(id),'11','').subscribe(res =>{
