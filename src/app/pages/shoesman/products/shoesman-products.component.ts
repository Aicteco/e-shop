...
@Component({
  selector: 'app-shoesman-products',
  templateUrl: './shoesman-products.component.html',
  styleUrls: ['./shoesman-products.component.scss']
})
export class ShoesmanProductsComponent implements OnInit {
 ...
 private spinner:NgxSpinnerService,
  ...
  ngOnInit(): void {
   ...
   getSlide(id){String(id)
    this.spinner.show();
   this.productServices.getAll('1','900', String(id),'5','').subscribe(res =>{
